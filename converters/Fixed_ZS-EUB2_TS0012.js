...
const definition = {
    zigbeeModel: ['Fixed_ZS-EUB2_TS0012'], // The model ID from: Device with modelID 'lumi.sens' is not supported.
    model: 'Fixed ZS-EUB2 TS0012', // Vendor model number, look on the device for a model number
    vendor: 'DocLab, ex TuYa', // Vendor of the device (only used for documentation and startup logging)        
    description: 'Wireless switch with 2 button', // Description of the device, copy from vendor site. (only used for documentation and startup logging)

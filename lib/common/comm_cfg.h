...
#define IMAGE_TYPE_SWITCH_TS0012            (0x22 | (IMAGE_TYPE_BOOT_FLAG << 7))
...
#define BOARD_8258_TUYA_SWITCH_TS0012       15
...
/* Board define */
    ...
    #elif defined(BUILD_TS0012)
        #define BOARD                       BOARD_8258_TUYA_SWITCH_TS0012
    #else
...
#elif (BOARD == BOARD_8258_TUYA_SWITCH_TS0012)
